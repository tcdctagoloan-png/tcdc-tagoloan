...
// Route for Form 3 - Parent Information Form with Emergency Contact
Route::get('/form3', function () {
    echo "<h1>Parent Information</h1>";
    echo "<form action='/form4' method='GET'>";
    echo "<table>
            <tr>
    ...
    echo "<h4>In case of Emergency, Please Contact:</h4>";
    echo "<table>
            <tr>
                <td>Name:</td>
                ...
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td>Number:</td>
                <td><input type='tel' name='emergency_number'></td>
            </tr>
          </table><br>";
...
// Route for Form 4 - Registration Complete
Route::get('/form4', function () {
    echo "<h1>Registration Complete!</h1>";
    echo "<form action='/form1' method='GET'>";
    echo "<button type='submit'>Return to Form 1</button>";
    echo "</form>";
    echo "</div>";
});
